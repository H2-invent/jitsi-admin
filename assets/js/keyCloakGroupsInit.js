import $ from "jquery";
 function addFormToCollection($collectionHolderClass) {
    ...
    let  $newFormLi = $('<li class="d-inline-block"></li>').append(newForm);
...
function addTagFormDeleteLink($tagFormLi) {
    var $removeFormButton = $('<a href="#" class="deleteKeyCloakGroup" type="remove-group"><i class="text-danger px-1 fas fa-trash" data-toggle="tooltip" title="Delete Keycloak Group" data-original-title="Delete Keycloak Group"></i></a>');

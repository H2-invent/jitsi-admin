...
replace="mysql://"$databaseUsername:$databasePassword@$databaseHost:$databasePort/$databaseName
search="mysql://<user>:<password>@<server>:3306/<database>"
sed -i 's/$search/$replace/' .env.local

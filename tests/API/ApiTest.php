...
class ApiTest extends WebTestCase
{
    ...
    public function testgetOptions(): void
    {
        ...
        $room = $roomRepo->findOneBy(array('uidReal'=>$uid));
        ...
        $this->assertEquals($urlGenerator->generate('room_join',array('room'=>$room->getId(),'t'=>'b'),UrlGeneratorInterface::ABSOLUTE_URL),json_decode($client->getResponse()->getContent(), true)['joinBrowser']);
        $this->assertEquals($urlGenerator->generate('room_join',array('room'=>$room->getId(),'t'=>'a'),UrlGeneratorInterface::ABSOLUTE_URL),json_decode($client->getResponse()->getContent(), true)['joinApp']);

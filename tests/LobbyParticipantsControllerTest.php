...
class LobbyParticipantsControllerTest extends WebTestCase
{
    ...
    public function testLobby(): void
    {
        ...
        $url = $urlGenerator->generate('lobby_participants_wait',array('roomUid'=>$room->getUid(),'userUid'=>$user2->getUid()));
    ...
    public function testRenew(): void
    {
        ...
        $lobbyUSerRepo = self::getContainer()->get(LobbyWaitungUserRepository::class);
        $urlGenerator = self::getContainer()->get(UrlGeneratorInterface::class);
        $urlRenew = $urlGenerator->generate('lobby_participants_renew',array('roomUid'=>$room->getUid(),'userUid'=>$user2->getUid()));
    ...
    public function testLeave(): void
    {
        ...
        $lobbyUSerRepo = self::getContainer()->get(LobbyWaitungUserRepository::class);
        $urlGenerator = self::getContainer()->get(UrlGeneratorInterface::class);
        $urlLeave = $urlGenerator->generate('lobby_participants_leave',array('roomUid'=>$room->getUid(),'userUid'=>$user2->getUid()));

...
class CreateWhiteboardServiceTest extends KernelTestCase
{
    ...
    public static string $sampleSvg = '<svg id="canvas" width="3109" height="2590" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
#textToolInput { position: fixed; top: -1000px; left: 80px; width: 500px; },#textToolInput:focus { top: 5px; },text { font-family: Arial, Helvetica, sans-serif; user-select: none; }</style></svg>';
    ...
    {
        self::$sampleSvgResult = '<div class="page_break"></div><img src="data:image/svg+xml;base64,' . (base64_encode(self::$sampleSvg)) . '" style="width: 600px"/>';
    }
    ...
    public function testWhiteboardSuccess(): void
    {
        ...
        self::assertSame($whiteboardResponse, self::$sampleSvgResult);

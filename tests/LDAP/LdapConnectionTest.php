...
{
    public static int $UserInLDAP = 4;
    public static int $USERWITHLDAPUSERPROPERTIES = 5;
    public static int $UserInSubLDAP = 2;
    public static int $UserInOneLDAP = 2;
    public string $LDAPURL = 'ldap://192.168.230.128:10389';

    /** @var array<int, string> */
    private static array $testURLTrue = [
    ...
    /** @var array<int, string> */
    private static array $testURLFalse = [
    ...
    protected function setUp(): void
    {
        ...
        /** @var string $ldapTestUrl */
        $ldapTestUrl = $para->get('ldap_test_url');
        $this->LDAPURL = $ldapTestUrl;
    }

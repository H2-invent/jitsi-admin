...
class NewMemberType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
           ->add('member',TextareaType::class,['required' => false, 'label' => 'E-Mail Adresse von neuem Teilnehmern eingeben', 'help'=> 'Es können mehrere Teilnehmer auf einmal hinzugefügt werden. Jede E-Mail Adresse muss in eine neue Zeile schreiben. Wenn die E-Mail Adresse im diesem Jitsi Manager noch nicht vorhanden ist, wird ein neues Konto angelegt und der Empfänger wird per E-Mail darüber informiert.','translation_domain' => 'form'])

 ...
 */
final class Version20220630112622 extends AbstractMigration
{
    ...
    {
        $this->skipIf($this->connection->getDatabasePlatform()->getName() != 'postgresql', 'Migration can only be executed safely on \'PostgresSql\'.');

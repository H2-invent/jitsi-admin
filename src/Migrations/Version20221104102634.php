 ...
 */
final class Version20221104102634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform()->getName() !== 'postgresql') {
            ...
            $this->addSql('ALTER TABLE rooms ADD CONSTRAINT FK_7CA11A9661220EA6 FOREIGN KEY (creator_id) REFERENCES fos_user (id)');
